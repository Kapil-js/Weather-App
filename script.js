...
const innerData = document.querySelector('.inner-conatiner');
...
const apiKey = '0b8d4d6e9a70091205b30501ebfdfacc'
...
form.addEventListener('submit', (event) =>{
    ...
    const fetchWeather = async function () {
        const responce = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${cityName.value}&appid=${apiKey}`)
